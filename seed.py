...
Tank = Pet(name= 'Tank', species='Dog', photo_url='/Pepper.JPG' age='7', available=True)
Pepper = Pet(name= 'Pepper', species='Dog', photo_url='/Percy.JPG' age='6')
Percy = Pet(name= 'Percy', species='Dog', photo_url='Tank.jpeg' age='3')
